            ...
            <div className='form-container'>
                <form>
                    ...
                    <div className='button-box'>
                        <button className='but-reject' onClick={()=>{alert('Your Application is Rejected')}}>Reject</button>
                        <button className='but-approve'  onClick={()=>{alert('Your Application is Approved')}}>Approve</button>
                    </div>
                </form>
            </div>
        </div>
